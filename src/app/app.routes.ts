...
{path:'dashboard',component:DashboardComponent},{path:'crear-test',component:CustomTestComponent},{path:'tests',component:TestsLibraryComponent},{path:'temas/:id',component:TopicDetailComponent},{path:'test/personalizado',component:TestPlayerComponent,data:{source:'CUSTOM'}},{path:'test/repaso',component:TestPlayerComponent,data:{source:'REVIEW'}},{path:'test/falladas',component:TestPlayerComponent,data:{source:'FAILED'}},{path:'test/falladas-tema',component:TestPlayerComponent,data:{source:'FAILED_TOPIC'}},{path:'oficiales/:id',component:OfficialExamDetailComponent},{path:'oficiales/:id/realizar',component:ExamPlayerComponent},{path:'resultado/:id',component:ResultComponent},{path:'repasar',component:ReviewTestComponent},{path:'falladas',component:MistakesComponent},{path:'',pathMatch:'full',redirectTo:'dashboard'}]},
